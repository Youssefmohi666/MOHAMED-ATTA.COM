        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ViewersCount = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LiveStreams_Users_InstructorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChatMessages_LiveStreams_StreamId",
                        column: x => x.StreamId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AiLearningActivities", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AiLearningActivities_Students_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BillingFullName = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LectureProgress_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CurriculumLectures", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CurriculumLectures_CurriculumSections_SectionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AiLearningActivities_StudentId",
                table: "AiLearningActivities",
                column: "StudentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CurriculumLectures_SectionId",
                table: "CurriculumLectures",
                column: "SectionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LectureProgress_UserId",
                table: "LectureProgress",
                column: "UserId");
